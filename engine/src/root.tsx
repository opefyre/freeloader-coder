...
/** Route-module hydration placeholder used while client loaders initialize. */
...
export const meta: MetaFunction = () => [
  ...
  {
    name: "description",
    content: "Build products with an autonomous software pipeline.",
  },
];
...
export default function App() {
  ...
  return (
    <>
      <Outlet />
      {!isPipelineStudio ? <TelemetryConsentBanner /> : null}
    </>
  );
}
