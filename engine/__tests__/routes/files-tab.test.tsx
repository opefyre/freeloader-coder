...
describe("FilesTab", () => {
  ...
  it("uses the workspace fileserver URL as the iframe src for HTML files", async () => {
    ...
    // Interactive previews run scripts in an opaque sandbox origin. Omitting
    // `allow-same-origin` prevents workspace code from reaching Codkesh DOM,
    // storage, cookies, or authenticated APIs.
