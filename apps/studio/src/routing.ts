...
export const workspaceDefinitions = {
  overview: {
    ...
    label: "Overview",
    mobileLabel: "Home",
    note: "Pipeline health and decisions",
    eyebrow: "Freeloader Coder · Local operations",
    title: "Your local pipeline",
    description: "Live projects, requests, and free-provider readiness from this computer.",
    group: "primary",
    mobile: true,
  },
  projects: {
  ...
  work: {
    ...
    eyebrow: "Demo: 1 active · 8 queued",
