...
export const workspaceDefinitions = {
  overview: {
    ...
    eyebrow: "Your product workspace",
    title: "What would you like to build?",
    description: "Start with an idea, a file, or an existing project. The pipeline organizes the rest.",
    group: "primary",
    mobile: true,
  },
  projects: {
  ...
  activity: {
    ...
    note: "Progress, attention, and reports",
    eyebrow: "Live progress and attention",
    title: "Everything that is happening",
    description: "Follow active work, review what needs you, and open technical evidence only when you want it.",
    group: "primary",
    mobile: true,
  },
  providers: {
  ...
  settings: {
    ...
    description: "Connect providers and services, choose automation preferences, and control privacy and spending.",
    group: "secondary",
    mobile: false,
  },
