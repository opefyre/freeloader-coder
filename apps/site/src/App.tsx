...
const faq = [
  ...
  ["Is the public release complete?", "No. The technical foundation is a private-beta candidate. Public hosting, field adoption evidence, and live paid-provider integrations remain open work."]
] as const;
...
function App() {
  ...
  return <>
    ...
    <main id="main">
      ...
      <section className="final-cta section"><img src="/pipeline-studio-mark.svg" alt="" /><p className="eyebrow">Built in the open</p><h2>Make the work autonomous.<br />Keep the authority human.</h2><p>Explore the source today. Public hosting and field adoption evidence are still on the roadmap.</p><div><a className="button primary" href={repositoryUrl} target="_blank" rel="noreferrer"><GithubLogo size={19} weight="fill" /> View on GitHub</a><a className="button secondary" href="#demo">Replay the demo</a></div></section>
    </main>
