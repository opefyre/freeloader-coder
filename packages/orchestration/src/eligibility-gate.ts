...
export type EligibilityDecision = {
  ...
  override: { authorizedBy: "owner"; rationale: string; at: number } | null;
  decidedAt: number;
};
...
export function authorizeEligibilityOverride(decision: EligibilityDecision, input: { authorizedBy: "owner"; rationale: string; at: number }): EligibilityDecision {
  ...
  return { ...decision, eligible: true, override: { authorizedBy: "owner", rationale: input.rationale.trim(), at: input.at } };
}
